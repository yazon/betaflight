...
uint16_t firStaticFilterFsAndTapsSize[FIR_STATIC_FILTER_FILTER__MAX][3] = {
	{FIR_STATIC_FILTER_FS_1KHZ_VALUE, FIR_STATIC_FILTER_FS_1KHZ_TAPS_SIZE, LPF_GYRO_FILTER_FS_1KHZ_TAPS_SIZE},
	{FIR_STATIC_FILTER_FS_2KHZ_VALUE, FIR_STATIC_FILTER_FS_2KHZ_TAPS_SIZE, LPF_GYRO_FILTER_FS_2KHZ_TAPS_SIZE},
	{FIR_STATIC_FILTER_FS_4KHZ_VALUE, FIR_STATIC_FILTER_FS_4KHZ_TAPS_SIZE, LPF_GYRO_FILTER_FS_4KHZ_TAPS_SIZE},
	{FIR_STATIC_FILTER_FS_8KHZ_VALUE, FIR_STATIC_FILTER_FS_8KHZ_TAPS_SIZE, LPF_GYRO_FILTER_FS_8KHZ_TAPS_SIZE},
	{FIR_STATIC_FILTER_FS_16KHZ_VALUE, FIR_STATIC_FILTER_FS_16KHZ_TAPS_SIZE, LPF_GYRO_FILTER_FS_16KHZ_TAPS_SIZE}};
...
//	{
		if(refreshRate == 1000) {
			fs_idx = (uint8_t) FIR_STATIC_FILTER_FS_1KHZ;
			...
			fs_idx = (uint8_t) FIR_STATIC_FILTER_FS_2KHZ;
			...
			fs_idx = (uint8_t) FIR_STATIC_FILTER_FS_4KHZ;
			...
			fs_idx = (uint8_t) FIR_STATIC_FILTER_FS_8KHZ;
...
//	}
	...
	filter->axis = axis;
	filter->lpfFsTaps.fs = firStaticFilterFsAndTapsSize[fs_idx][0];
	filter->lpfFsTaps.taps = firStaticFilterFsAndTapsSize[fs_idx][2];
	...
	arm_fir_init_f32(&filter->lpf_instance, lpfCoeffsSize, (float32_t *)filter->noiseFilter.lpfFirTaps,
			(float32_t *)&filter->noiseFilter.lpfFirState[0], FIR_STATIC_FILTER_BS);
...
float firStaticFilterApply(firStaticFilter_t *filter, float input)
{
	...
	arm_fir_f32(&filter->lpf_instance, &input, &output, FIR_STATIC_FILTER_BS);
